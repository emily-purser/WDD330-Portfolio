...
//   const quakeControl = new QuakesController();
//   const quakeView = new QuakesView();
//   // get the current location
//   const location = await quakeControl.initPos();
//   // get the list of quakes for the location
//   quakes = await quakeControl.getQuakesForLocation(location);
